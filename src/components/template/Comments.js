...
function Comments({ session, id }) {
  return (
    <div className="rounded-xl px-2 py-3 shadow-xl shadow-blue-300 dark:shadow-cyan-800">
      <h1 className="mb-2 flex items-center gap-2 text-sm font-semibold dark:text-white">
